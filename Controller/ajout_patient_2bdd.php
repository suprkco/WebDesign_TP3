<?php
    ...
    // Id_Patient, Nom_Patient, Prenom_Patient, Sexe_Patient, Adresse_Patient, Ville_Patient, Departement_Patient, Date_Naissance_Patient, Situation_Familiale_Patient, Affiliation_Mutuelle, Date_Creation_Dossier 	
